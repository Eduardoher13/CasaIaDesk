...
exports.MembershipModule = MembershipModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [memberships_controller_1.MembershipController],
        providers: [memberships_service_1.MembershipService],
        exports: [memberships_service_1.MembershipService],
    })
], MembershipModule);
